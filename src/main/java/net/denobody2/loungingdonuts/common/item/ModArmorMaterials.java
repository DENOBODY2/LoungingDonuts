...
public enum ModArmorMaterials implements ArmorMaterial {
    DONUT("donut", 33, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
        p_266655_.put(ArmorItem.Type.BOOTS, 3);
        p_266655_.put(ArmorItem.Type.LEGGINGS, 6);
        p_266655_.put(ArmorItem.Type.CHESTPLATE, 7);
        p_266655_.put(ArmorItem.Type.HELMET, 3);
    }), 20, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0F, 0.1F, () -> Ingredient.of(ModItems.DONUT_INGOT.get()));
    ...
    public String getName() {
        return LoungingDonuts.MOD_ID + ":" + this.name;
    }
